...
if __name__ == "__main__":
    ...
    kwargs_gridsearch = {"cutoff":[0.1, 0.5, 1.0],
                         ...
                         "HMM":[True, False],
                         "HMM_report_by":["subcluster", "consensus"],  # cell removed due to long computational time
                         "HMM_type":["i6", "i3"],
                         "BayesMaxPNormal":[0.3, 0.5, 0.7],
                         "sim_method":["meanvar"],
                         "sim_foreground":[True, False],
                         "reassignCNVs":[True],
                         "analysis_mode":["samples", "subclusters"],  # cell removed due to long computational time
